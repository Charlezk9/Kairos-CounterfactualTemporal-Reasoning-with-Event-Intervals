...
- 状态：`IMPLEMENTED / SYNTHETIC VERIFIED / INDEPENDENT RE-AUDIT APPROVED / REAL EXECUTION PENDING`。D-039 的 immutable gold-blind 工件经 fresh replay 后，train 330 条中恰有 3 条没有任何成功解析的生成候选；internal-dev 36 条均非空。train 空池 pair ID 的 source-order canonical list SHA256 为 `22b4edc8c53acf2971d1d618da17388ea34c759188fab4b32ed41f384d22161a`。不得删除这 3 条、修改 prompt/parser、伪造生成候选或把 gold 写回候选工件。
