...
- 状态：`FROZEN FOR IMPLEMENTATION / GOLD-BLIND`；冻结父提交为 `0c2b7bf8706a268437494978d02b7f915d1862dc`。该基线是额外 prompt-candidate structured baseline，不冒充 Kairos/Pair-MLP/Same-data SFT 的 same-supervision 主比较，不解除 D-023 训练门禁。
