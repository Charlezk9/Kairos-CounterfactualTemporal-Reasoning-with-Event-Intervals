...
| `DEV-P01-ARCHIVE-20260722` | 2026-07-22 | archive safety and full repository unit tests | dirty, based on `b6491ec` | 49/49 passed after three audit-remediation rounds; full re-audit pending | none |
