...
| `DEV-P03-QWEN-CORE-ADAPTER-20260724` | 2026-07-24 | strict synthetic Qwen hidden-state/candidate adapter shared by Kairos and Pair-MLP, frozen LoRA targets and trainable-state round-trip | clean commit `14f71040e4a490476c3372b1325b763843b360d9` | focused 7/7; full 522/522 in 14.955s; CPU-only full forward/loss/backward for both cores | none |
| `DEV-P03-RESUMABLE-TRAINING-20260724` | 2026-07-24 | D-028 synthetic-only two-group optimizer, accumulation/scheduler/RNG and immutable checkpoint/resume execution for Kairos and Pair-MLP | clean commit `7772f7c0b83557c423456de62a3fd733781e3499` | focused 20/20 in 1.830s; full 528/528 in 18.175s; exact CPU BF16 uninterrupted versus interrupted/resumed equivalence; test checkpoints removed | none |
...
| `ACQ-2WIKI-RECOVERY-20260724` | `DEFERRED_NETWORK / ALL_FROZEN_ROUTES_UNREACHABLE` | April 2021 corrected + two official older objects + unofficial mirror `6ef4eb1...` | `08d847b` | none | four Dropbox routes/probes returned curl 28, HTTP 000 and zero bytes; pinned HF mirror failed with OS `Network is unreachable`; attempt manifests `47a72d53...`, `61cb88de...`, `7777d531...`, `acebe358...`, `69416fdb...` | `/data0/hk_data/kairos-zx/.tmp/2wiki-recovery-20260724-*` |
...
| `PROC-P01-GSM8K-AI-ASSISTED-TRAINING-COPY-20260725` | `VERIFIED COPY / DEVELOPMENT TRAINING ONLY / FORMAL HUMAN ARTIFACT PENDING` | `3101c7d5072418e28b9008a6636bde82a006892c` | user-resolution commit `4dba42a2765c8667576d87599269e836755888e8` | source 370; user-resolved audit valid/invalid 196/4; excluded known-invalid pairs 4; output 366; CF answer unavailable | data/manifest SHA256 `4b5fec2bf46b1b86df9639b0e2cea9bc355e77be04247f5f27fcef3cb725f788` / `f24a8e8ef2ee3f5abf75938e620b43a8c2dcb52b52459ac000ba97bc87258b5a`; full source-order/filter replay passed; conditional human κ 1.0 is not artifact-backed | `/data0/hk_data/kairos-zx/data/processed/gsm8k/3101c7d5072418e28b9008a6636bde82a006892c/training-data-v1/ai-assisted-user-checked-relation-only-v1/train` |
| `PROC-P01-GSM8K-AUDIT-BOUND-TRAINING-V2-20260725` | `VERIFIED / DEVELOPMENT ONLY / PARTITION FROZEN` | `3101c7d5072418e28b9008a6636bde82a006892c` | `3c02685845f54475b7bca834200aa584b02e4a6c` | source 370; D-038-derived exclusions 4; retained 366; train 330; internal-dev 36; CF answer unavailable | data/train/dev/partition/manifest SHA256 `4b5fec2b...` / `073b4c65...` / `63041d7e...` / `cfc1894e...` / `0631e02c...`; fresh full-chain replay passed; optimizer eligibility only train330 | `/data0/hk_data/kairos-zx/data/processed/gsm8k/3101c7d5072418e28b9008a6636bde82a006892c/training-data-v2/audit-bound-user-attested-relation-only-v1-train` |
